Play area for nefug (new england fedora users group) meeting may 11-12 2015

Based on 'https://github.com/fcrepo4-labs/fcrepo4-vagrant' (that readme text  is below).
